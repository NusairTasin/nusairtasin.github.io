  ...
  return (
    <>
      <nav className="text-white fixed top-0 z-10 flex w-full items-center justify-between border-b border-b-gray-700 bg-black/70 sm:px-16 px-12 py-5 backdrop-blur-md md:justify-evenly">
        ...
        {isOpen && (
          <div
            className={`fixed right-0 top-[12vh] md:hidden flex h-screen/2 w-full flex-col items-center justify-center gap-10 border-l border-gray-800 bg-black/90 py-12 px-11 ${
              isOpen ? "block" : "hidden"
            }`}
          >
